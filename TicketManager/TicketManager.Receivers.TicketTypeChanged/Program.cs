...
namespace TicketManager.Receivers.TicketTypeChanged
{
    internal class Program
    {
        ...
        private const string Subscription = "tickettypechanged.querystoresync";

        private static async Task Main(string[] args)
        {
            var host = new ReceiverHostBuilder()
                .CreateDefaultBuilder<TicketTypeChangedNotificationReceiver>(Topic, Subscription)
            ...
            await host.SetupSubscriptionAsync<TicketTypeChangedNotification>();
