...
namespace TicketManager.WebAPI.Services.CommandHandlers
{
    public class CancelTicketInvolvementCommandHandler : IRequestHandler<CancelTicketInvolvementCommand>
    {
        ...
        public CancelTicketInvolvementCommandHandler(ICorrelationIdProvider correlationIdProvider, IMediator mediator, IEventsContextFactory eventsContextFactory, IValidator<CancelTicketInvolvementCommand> validator)
        {
