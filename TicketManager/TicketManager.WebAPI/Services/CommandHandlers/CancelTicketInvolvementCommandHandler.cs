...
namespace TicketManager.WebAPI.Services.CommandHandlers
{
    public class CancelTicketInvolvementCommandHandler : IRequestHandler<CancelTicketInvolvementCommand>
    {
        ...
        public CancelTicketInvolvementCommandHandler(ICorrelationIdProvider correlationIdProvider, IMessagePublisher messagePublisher, IEventsContextFactory eventsContextFactory, IValidator<CancelTicketInvolvementCommand> validator)
        {
        ...
        public async Task<Unit> Handle(CancelTicketInvolvementCommand request, CancellationToken cancellationToken)
        {
            ...
            var message = new PublishMessageRequest<TicketUserInvolvementCancelledNotification>(new TicketUserInvolvementCancelledNotification(ticketId), correlationId);
