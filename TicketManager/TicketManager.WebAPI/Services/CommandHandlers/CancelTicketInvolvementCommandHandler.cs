...
namespace TicketManager.WebAPI.Services.CommandHandlers
{
    public class CancelTicketInvolvementCommandHandler : IRequestHandler<CancelTicketInvolvementCommand>
    {
        ...
        public CancelTicketInvolvementCommandHandler(ICorrelationIdProvider correlationIdProvider, IServiceBusTopicSender serviceBusTopicSender, IEventsContextFactory eventsContextFactory, IValidator<CancelTicketInvolvementCommand> validator)
        {
        ...
        public async Task<Unit> Handle(CancelTicketInvolvementCommand request, CancellationToken cancellationToken)
        {
            ...
            await serviceBusTopicSender.SendAsync(new TicketUserInvolvementCancelledNotification(ticketId), correlationId).ConfigureAwait(false);
