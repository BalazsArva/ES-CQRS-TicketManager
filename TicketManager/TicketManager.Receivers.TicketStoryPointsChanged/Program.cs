...
namespace TicketManager.Receivers.TicketStoryPointsChanged
{
    internal class Program
    {
        ...
        private const string Subscription = "ticketstorypointschanged.querystoresync";

        private static async Task Main(string[] args)
        {
            var host = new ReceiverHostBuilder()
                .CreateDefaultBuilder<TicketStoryPointsChangedNotificationReceiver>(Topic, Subscription)
            ...
            await host.SetupSubscriptionAsync<TicketStoryPointsChangedNotification>();
