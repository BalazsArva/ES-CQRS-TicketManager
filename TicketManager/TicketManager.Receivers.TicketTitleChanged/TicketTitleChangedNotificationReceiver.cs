...
namespace TicketManager.Receivers.TicketTitleChanged
{
    public class TicketTitleChangedNotificationReceiver : SubscriptionReceiverHostBase<TicketTitleChangedNotification>
    {
        private readonly IDocumentStore documentStore;
        private readonly IEventAggregator<TicketTitle> eventAggregator;

        public TicketTitleChangedNotificationReceiver(ServiceBusSubscriptionConfiguration subscriptionConfiguration, IDocumentStore documentStore, IEventAggregator<TicketTitle> eventAggregator)
        ...
        public override async Task<ProcessMessageResult> HandleMessageAsync(TicketTitleChangedNotification notification, string correlationId, IDictionary<string, object> headers, CancellationToken cancellationToken)
        {
