...
namespace TicketManager.Receivers.TicketTitleChanged
{
    internal class Program
    {
        ...
        private const string Subscription = "tickettitlechanged.querystoresync";

        private static async Task Main(string[] args)
        {
            var host = new ReceiverHostBuilder()
                .CreateDefaultBuilder<TicketTitleChangedNotificationReceiver>(Topic, Subscription)
            ...
            await host.SetupSubscriptionAsync<TicketTitleChangedNotification>();
